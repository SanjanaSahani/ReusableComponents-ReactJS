  ...
  return (
    <>
      <div className='flex justify-center gap-10 cursor-pointer'>
        ...
        <button className='px-4 py-2 rounded-full font-sm  text-orange-400 hover:bg-orange-100 hover:text-orange-800 border-orange-500 border-2' type="button">{text}</button>
        ...
        <button className='px-4 py-2 font-sm  text-purple-400 hover:bg-purple-100 hover:text-purple-800 border-purple-500 border-2' type="button">{text}</button>
      </div>
    </>
  )
}
